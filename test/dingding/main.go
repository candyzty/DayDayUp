...
func main() {
	...
	//text类型
	textContent := "@15671660162 接旨服务准备发布！"
	atMobiles := robot.SendWithAtMobiles([]string{"15671660162"})
	//textContent := atMobiles + "接旨服务准备发布！"
	...
	actionCardText := "*服务器报警* \n" +
		">- 报警信息 \n" +
		">- 报警服务: takeaway \n" +
		">- 报警主机: 172.16.0.2 \n" +
		">- 报警状态：项目发布 \n" +
		">- 告警时间: 2020-08-04 22:32"

	//actionCardSingleTitle := "阅读全文"
	actionCardSingleURL := "https://www.baidu.com/"
	actionCardBtnOrientation := "1"
